...
describe('QlooClient Exact Requirements', () => {
  let qlooClient;
  ...
  describe('getRecommendations', () => {
    ...
    test('should return fallback data when API request fails with 4xx error', async () => {
      // Arrange
      process.env.QLOO_API_KEY = 'test-api-key';
      qlooClient = new QlooClient();
      const entityIds = ['entity1', 'entity2'];
    ...
    test('should return fallback data when API request fails with 5xx error', async () => {
      // Arrange
      process.env.QLOO_API_KEY = 'test-api-key';
      qlooClient = new QlooClient();
      const entityIds = ['entity1', 'entity2'];
